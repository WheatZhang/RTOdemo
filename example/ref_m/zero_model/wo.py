...
def generate_noise_file(noise_filename):
    cost_noise_level=0
...
def get_simulation_result():
    ...
    result_filename_folder = "data/wo/"
...
def draw_profile():
    ...
    for no,prefix in enumerate(["MA_ODM", "MA_ZERO"]):
        plant_data = pandas.read_csv("data/wo/" + prefix + "_plant_data.txt", \
    ...
    plt.savefig("pic/wo_profile", dpi=600)
    plt.close()


if __name__== "__main__":
    # generate_noise_file("../noise/noise0.txt")
