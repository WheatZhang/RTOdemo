...
def do_batch_test_algo12_main(model_name):
    ...
    do_batch_test_algo12(model_name, batch_prefix+"P", 0, default_u1_0, default_u2_0, default_r_0,default_r_max, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"P", 1, default_u1_0, default_u2_0, default_r_0,default_r_max, 5, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"P", 2, default_u1_0, default_u2_0, default_r_0,default_r_max, 1, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"P", 3, default_u1_0, default_u2_0, default_r_0,default_r_max, 0.5, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"P", 4, default_u1_0, default_u2_0, default_r_0,default_r_max, 0.1, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"P", 5, default_u1_0, default_u2_0, default_r_0,default_r_max, 0, default_xi_N)

    do_batch_test_algo12(model_name, batch_prefix + "PF", 0, 1.5, -1.5, default_r_0, default_r_max,
                         default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "PF", 1, 1.5, -1.5, default_r_0, default_r_max, 5,
                         default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "PF", 2, 1.5, -1.5, default_r_0, default_r_max, 1,
                         default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "PF", 3, 1.5, -1.5, default_r_0, default_r_max,
                         0.5, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "PF", 4, 1.5, -1.5, default_r_0, default_r_max,
                         0.1, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "PF", 5, 1.5, -1.5, default_r_0, default_r_max,
                         0, default_xi_N)

    do_batch_test_algo12(model_name, batch_prefix+"PIF", 0, -1.1, -0.1, default_r_0,default_r_max, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"PIF", 1, -1.1, -0.1, default_r_0,default_r_max, 5, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"PIF", 2, -1.1, -0.1, default_r_0,default_r_max, 1, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"PIF", 3, -1.1, -0.1, default_r_0,default_r_max, 0.5, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"PIF", 4, -1.1, -0.1, default_r_0,default_r_max, 0.1, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"PIF", 5, -1.1, -0.1, default_r_0,default_r_max, 0, default_xi_N)
    ...
    do_batch_test_algo12(model_name, batch_prefix+"X", 0, default_u1_0, default_u2_0, default_r_0, \
                         default_r_max, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix+"X", 1, default_u1_0, default_u2_0, default_r_0, \
                         default_r_max, default_sigma, 0.1)
    do_batch_test_algo12(model_name, batch_prefix+"X", 2, default_u1_0, default_u2_0, default_r_0, \
                         default_r_max, default_sigma, 0.3)
    do_batch_test_algo12(model_name, batch_prefix + "X", 3, default_u1_0, default_u2_0, default_r_0, \
                         default_r_max, default_sigma, 0.7)
    do_batch_test_algo12(model_name, batch_prefix + "X", 4, default_u1_0, default_u2_0, default_r_0, \
                         default_r_max, default_sigma, 0.9)

    do_batch_test_algo12(model_name, batch_prefix + "XF", 0, 1.5, -1.5, default_r_0, \
                         default_r_max, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "XF", 1, 1.5, -1.5, default_r_0, \
                         default_r_max, default_sigma, 0.1)
    do_batch_test_algo12(model_name, batch_prefix + "XF", 2, 1.5, -1.5, default_r_0, \
                         default_r_max, default_sigma, 0.3)
    do_batch_test_algo12(model_name, batch_prefix + "XF", 3, 1.5, -1.5, default_r_0, \
                         default_r_max, default_sigma, 0.7)
    do_batch_test_algo12(model_name, batch_prefix + "XF", 4, 1.5, -1.5, default_r_0, \
                         default_r_max, default_sigma, 0.9)

    do_batch_test_algo12(model_name, batch_prefix + "XIF", 0, -1.1, -0.1, default_r_0, \
                         default_r_max, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "XIF", 1, -1.1, -0.1, default_r_0, \
                         default_r_max, default_sigma, 0.1)
    do_batch_test_algo12(model_name, batch_prefix + "XIF", 2, -1.1, -0.1, default_r_0, \
                         default_r_max, default_sigma, 0.3)
    do_batch_test_algo12(model_name, batch_prefix + "XIF", 3, -1.1, -0.1, default_r_0, \
                         default_r_max, default_sigma, 0.7)
    do_batch_test_algo12(model_name, batch_prefix + "XIF", 4, -1.1, -0.1, default_r_0, \
                         default_r_max, default_sigma, 0.9)

    do_batch_test_algo12(model_name, batch_prefix + "XR", 0, default_u1_0, default_u2_0, default_r_0/10, \
                         default_r_max/10, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "XR", 1, default_u1_0, default_u2_0, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.1)
    do_batch_test_algo12(model_name, batch_prefix + "XR", 2, default_u1_0, default_u2_0, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.3)
    do_batch_test_algo12(model_name, batch_prefix + "XR", 3, default_u1_0, default_u2_0, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.7)
    do_batch_test_algo12(model_name, batch_prefix + "XR", 4, default_u1_0, default_u2_0, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.9)

    do_batch_test_algo12(model_name, batch_prefix + "XRF", 0, 1.5, -1.5, default_r_0/10, \
                         default_r_max/10, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "XRF", 1, 1.5, -1.5, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.1)
    do_batch_test_algo12(model_name, batch_prefix + "XRF", 2, 1.5, -1.5, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.3)
    do_batch_test_algo12(model_name, batch_prefix + "XRF", 3, 1.5, -1.5, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.7)
    do_batch_test_algo12(model_name, batch_prefix + "XRF", 4, 1.5, -1.5, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.9)

    do_batch_test_algo12(model_name, batch_prefix + "XRIF", 0, -1.1, -0.1, default_r_0/10, \
                         default_r_max/10, default_sigma, default_xi_N)
    do_batch_test_algo12(model_name, batch_prefix + "XRIF", 1, -1.1, -0.1, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.1)
    do_batch_test_algo12(model_name, batch_prefix + "XRIF", 2, -1.1, -0.1, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.3)
    do_batch_test_algo12(model_name, batch_prefix + "XRIF", 3, -1.1, -0.1, default_r_0/10, \
                         default_r_max/10, default_sigma, 0.7)
