...
def get_full_asu_model(build_constraint=False, binary_coeff=-0.01238, LOX = 17000):
    ...
    test_model.PR_CrtcTemp = Param(test_model.Component,
                                   initialize={'Oxygen': 154.77, 'Argon': 150.71, 'Nitrogen': 126.15})  # Temp unit: K
    ...
    test_model.PR_CompOmega = Param(test_model.Component, initialize={'Oxygen': 0.019, 'Argon': 0, 'Nitrogen': 0.045})
    ...
    test_model.PR_CPIGDP2 = Param(test_model.Component, initialize={'Oxygen': 1 / 4180 * 10040, 'Argon': 1 / 4180 * 0,
                                                                    'Nitrogen': 1 / 4180 * 8614.9})
    test_model.PR_CPIGDP3 = Param(test_model.Component, initialize={'Oxygen': 2526.5, 'Argon': 0, 'Nitrogen': 1701.6})
    test_model.PR_CPIGDP4 = Param(test_model.Component, initialize={'Oxygen': 1 / 4180 * 9356, 'Argon': 1 / 4180 * 0,
                                                                    'Nitrogen': 1 / 4180 * 103.47})
    test_model.PR_CPIGDP5 = Param(test_model.Component, initialize={'Oxygen': 1153.8, 'Argon': 0, 'Nitrogen': 909.79})
    test_model.PR_CPIGDP6 = Param(test_model.Component, initialize={'Oxygen': 50, 'Argon': -173.15, 'Nitrogen': 50})
    test_model.PR_CPIGDP7 = Param(test_model.Component, initialize={'Oxygen': 1500, 'Argon': 1226.85, 'Nitrogen': 1500})
    ...
    test_model.SRK_CrtcTemp = Param(test_model.Component,
                                    initialize={'Oxygen': 154.58, 'Argon': 150.86, 'Nitrogen': 126.2})  # Temp unit: K
    test_model.SRK_CrtcPressure = Param(test_model.Component, initialize={'Oxygen': 5042995.9125, 'Argon': 4897999.8375,
    ...
    test_model.SRK_CPIGDP1 = Param(test_model.Component,
                                   initialize={'Oxygen': 1 / 4180 * 29103, 'Argon': 1 / 4180 * 20786,
                                               'Nitrogen': 1 / 4180 * 29105})
    test_model.SRK_CPIGDP2 = Param(test_model.Component, initialize={'Oxygen': 1 / 4180 * 10040, 'Argon': 1 / 4180 * 0,
                                                                     'Nitrogen': 1 / 4180 * 8614.9})
    test_model.SRK_CPIGDP3 = Param(test_model.Component, initialize={'Oxygen': 2526.5, 'Argon': 0, 'Nitrogen': 1701.6})
    test_model.SRK_CPIGDP4 = Param(test_model.Component, initialize={'Oxygen': 1 / 4180 * 9356, 'Argon': 1 / 4180 * 0,
                                                                     'Nitrogen': 1 / 4180 * 103.47})
    test_model.SRK_CPIGDP5 = Param(test_model.Component, initialize={'Oxygen': 1153.8, 'Argon': 0, 'Nitrogen': 909.79})
    test_model.SRK_CPIGDP6 = Param(test_model.Component, initialize={'Oxygen': 50, 'Argon': -173.15, 'Nitrogen': 50})
    ...
    test_model.CoolLinSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.HeatLPCSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.ASCAllTrayssqrtaiTr = Var(test_model.ASCTrays, test_model.Component, initialize=0.29, bounds=(0.1, 0.6))
    ...
    test_model.ASCCondSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.HeatGanSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.RecoGanSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.RecoGarSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.RecoWnSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    test_model.RecoGoxSelfSqrt_ai = Var(test_model.Component, test_model.Component, initialize=0.17, bounds=(0.05, 0.4))
    ...
    def TaCoolerSelfai_Calc(m, comp):
        return 0.45724 * m.TaCoolerSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def TaCoolerSelfaL_Calc(m):
        return sum(
            [sum([m.TaCoolerSelfaij[c1, c2] * m.TaCoolerLiqMFrac[c1] * m.TaCoolerLiqMFrac[c2] for c1 in m.Component])
    ...
    def TaCoolerSelfaV_Calc(m):
        return sum(
            [sum([m.TaCoolerSelfaij[c1, c2] * m.TaCoolerVapMFrac[c1] * m.TaCoolerVapMFrac[c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def HpaCoolerSelfai_Calc(m, comp):
        return 0.45724 * m.HpaCoolerSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def HpaCoolerSelfaL_Calc(m):
        return sum(
            [sum([m.HpaCoolerSelfaij[c1, c2] * m.HpaCoolerLiqMFrac[c1] * m.HpaCoolerLiqMFrac[c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def HpaCoolerSelfaV_Calc(m):
        return sum(
            [sum([m.HpaCoolerSelfaij[c1, c2] * m.HpaCoolerVapMFrac[c1] * m.HpaCoolerVapMFrac[c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def MaCoolerSelfai_Calc(m, comp):
        return 0.45724 * m.MaCoolerSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def MaCoolerSelfaV_Calc(m):
        return sum([sum([m.MaCoolerSelfaij[c1, c2] * m.FeedMFrac[c1] * m.FeedMFrac[c2] for c1 in m.Component]) for c2 in
                    m.Component])
    ...
    def HPCAllTraysaL_Calc(m, tray):
        return sum([sum([m.HPCAllTraysaij[tray, c1, c2] * m.HPCLiqLvMFrac[tray, c1] * m.HPCLiqLvMFrac[tray, c2] for c1
    ...
    def HPCAllTraysa3_Calc(m, tray):
        return m.HPCAllTraysBL[tray] ** 2 + m.HPCAllTraysBL[tray] ** 3 - m.HPCAllTraysAL[tray] * m.HPCAllTraysBL[tray]

    test_model.HPCAllTraysa3 = Expression(test_model.HPCTrays, rule=HPCAllTraysa3_Calc)

    def HPCAllTraysaV_Calc(m, tray):
        return sum([sum([m.HPCAllTraysaij[tray, c1, c2] * m.HPCVapLvMFrac[tray, c1] * m.HPCVapLvMFrac[tray, c2] for c1
                         in m.Component]) for c2 in m.Component])
    ...
    def HPCAllTraysb3_Calc(m, tray):
        return m.HPCAllTraysBV[tray] ** 2 + m.HPCAllTraysBV[tray] ** 3 - m.HPCAllTraysAV[tray] * m.HPCAllTraysBV[tray]
    ...
    def HPCCondOutletai_Calc(m, comp):
        return 0.45724 * m.HPCCondOutletalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def HPCCondOutletaL_Calc(m):
        return sum(
            [sum([m.HPCCondOutletaij[c1, c2] * m.HPCVapLvMFrac[41, c1] * m.HPCVapLvMFrac[41, c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def CoolLinSelfai_Calc(m, comp):
        return 0.45724 * m.CoolLinSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def CoolLinSelfaL_Calc(m):
        return sum(
            [sum([m.CoolLinSelfaij[c1, c2] * m.HPCVapLvMFrac[41, c1] * m.HPCVapLvMFrac[41, c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def ThrottleSelfai_Calc(m, comp):
        return 0.45724 * m.ThrottleSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def ThrottleSelfaL_Calc(m):
        return sum(
            [sum([m.ThrottleSelfaij[c1, c2] * m.ThrottleLiqMFrac[c1] * m.ThrottleLiqMFrac[c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def ThrottleSelfaV_Calc(m):
        return sum(
            [sum([m.ThrottleSelfaij[c1, c2] * m.ThrottleVapMFrac[c1] * m.ThrottleVapMFrac[c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def ThrottleMEtlp(m):
        return (m.ThrottleLiqMEtlp * m.ThrottleLiqMFlow + m.ThrottleVapMEtlp * m.ThrottleVapMFlow) / m.HPCSumpOutMFlow
    ...
    def HeatLPCSelfai_Calc(m, comp):
        return 0.45724 * m.HeatLPCSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def HeatLPCSelfaL_Calc(m):
        return sum(
            [sum([m.HeatLPCSelfaij[c1, c2] * m.HeatLPCLiqMFrac[c1] * m.HeatLPCLiqMFrac[c2] for c1 in m.Component]) for
             c2 in m.Component])
    ...
    def HeatLPCSelfaV_Calc(m):
        return sum(
            [sum([m.HeatLPCSelfaij[c1, c2] * m.HeatLPCVapMFrac[c1] * m.HeatLPCVapMFrac[c2] for c1 in m.Component]) for
             c2 in m.Component])
    ...
    def LPCAllTraysaL_Calc(m, tray):
        return sum([sum([m.LPCAllTraysaij[tray, c1, c2] * m.LPCLiqLvMFrac[tray, c1] * m.LPCLiqLvMFrac[tray, c2] for c1
                         in m.Component]) for c2 in m.Component])
    ...
    def LPCAllTraysa3_Calc(m, tray):
        return m.LPCAllTraysBL[tray] ** 2 + m.LPCAllTraysBL[tray] ** 3 - m.LPCAllTraysAL[tray] * m.LPCAllTraysBL[tray]

    test_model.LPCAllTraysa3 = Expression(test_model.LPCTrays, rule=LPCAllTraysa3_Calc)

    def LPCAllTraysaV_Calc(m, tray):
        return sum([sum([m.LPCAllTraysaij[tray, c1, c2] * m.LPCVapLvMFrac[tray, c1] * m.LPCVapLvMFrac[tray, c2] for c1
                         in m.Component]) for c2 in m.Component])
    ...
    def LPCAllTraysb3_Calc(m, tray):
        return m.LPCAllTraysBV[tray] ** 2 + m.LPCAllTraysBV[tray] ** 3 - m.LPCAllTraysAV[tray] * m.LPCAllTraysBV[tray]
    ...
    test_model.LPCReboilerHdlpaij = Expression(test_model.Component, test_model.Component, rule=LPCReboilerHdlpaij_Calc)

    def LPCReboilerHdlpaL_Calc(m):
        return sum([sum([m.LPCReboilerHdlpaij[c1, c2] * m.LPCReboilerLiqLvMFrac[c1] * m.LPCReboilerLiqLvMFrac[c2] for c1
                         in m.Component]) for c2 in m.Component])
    ...
    def LPCReboilerHdlpAL_Calc(m):
        return m.LPCReboilerHdlpaL * m.LPCReboilerPressure * 1000 / ((m.PR_RGas * (m.LPCReboilerTemp + 273.15)) ** 2)
    ...
    def LPCReboilerHdlpaV_Calc(m):
        return sum([sum([m.LPCReboilerHdlpaij[c1, c2] * m.LPCReboilerVapLvMFrac[c1] * m.LPCReboilerVapLvMFrac[c2] for c1
                         in m.Component]) for c2 in m.Component])
    ...
    def LPCReboilerHdlpAV_Calc(m):
        return m.LPCReboilerHdlpaV * m.LPCReboilerPressure * 1000 / ((m.PR_RGas * (m.LPCReboilerTemp + 273.15)) ** 2)
        ...
        return sum([m.LPCReboilerVapLvMFrac[c] * m.LPCReboilerHdlpH0[c] for c in m.Component]) + \
            m.PR_RGas * (m.LPCReboilerTemp + 273.15) * ((m.LPCReboilerHdlpZV - 1) - 1 / (2 ** 1.5) * (
                        1 / m.LPCReboilerHdlpBV) * m.LPCReboilerHdlpZVdivBV * \
                                                        sum([sum([m.LPCReboilerVapLvMFrac[c1] * m.LPCReboilerVapLvMFrac[
        ...
        return sum([m.LPCReboilerLiqLvMFrac[c] * m.LPCReboilerHdlpH0[c] for c in m.Component]) + \
            m.PR_RGas * (m.LPCReboilerTemp + 273.15) * ((m.LPCReboilerHdlpZL - 1) - 1 / (2 ** 1.5) * (
                        1 / m.LPCReboilerHdlpBL) * m.LPCReboilerHdlpZLdivBL * \
                                                        sum([sum([m.LPCReboilerLiqLvMFrac[c1] * m.LPCReboilerLiqLvMFrac[
    ...
    def ASCAllTraysam_Calc(m, tray):
        return sum([sum([m.ASCAllTraysaij[tray, c1, c2] * m.ASCLiqLvMFrac[tray, c1] * m.ASCLiqLvMFrac[tray, c2] for c1
                         in m.Component]) for c2 in m.Component])
    ...
    def ASCAllTraysB_Calc(m, tray):
        return m.ASCAllTraysbm[tray] * m.ASCTrayPressure[tray] * 1000 / (m.SRK_RGas * (m.ASCTrayTemp[tray] + 273.15))
    ...
    def ASCCondSelfam_Calc(m):
        return sum(
            [sum([m.ASCCondSelfaij[c1, c2] * m.ASCCondLiqMFrac[c1] * m.ASCCondLiqMFrac[c2] for c1 in m.Component]) for
             c2 in m.Component])
    ...
    def HeatGanSelfai_Calc(m, comp):
        return 0.45724 * m.HeatGanSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def HeatGanSelfaV_Calc(m):
        return sum(
            [sum([m.HeatGanSelfaij[c1, c2] * m.LPCVapLvMFrac[52, c1] * m.LPCVapLvMFrac[52, c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def RecoGanSelfai_Calc(m, comp):
        return 0.45724 * m.RecoGanSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def RecoGanSelfaV_Calc(m):
        return sum(
            [sum([m.RecoGanSelfaij[c1, c2] * m.LPCVapLvMFrac[52, c1] * m.LPCVapLvMFrac[52, c2] for c1 in m.Component])
             for c2 in m.Component])
    ...
    def RecoGarSelfai_Calc(m, comp):
        return 0.45724 * m.RecoGarSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def RecoGarSelfaV_Calc(m):
        return sum(
            [sum([m.RecoGarSelfaij[c1, c2] * m.ASCCondVapMFrac[c1] * m.ASCCondVapMFrac[c2] for c1 in m.Component]) for
             c2 in m.Component])
    ...
    def RecoWnSelfai_Calc(m, comp):
        return 0.45724 * m.RecoWnSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def RecoWnSelfaV_Calc(m):
        return sum(
            [sum([m.RecoWnSelfaij[c1, c2] * m.LPCExt46MFrac[c1] * m.LPCExt46MFrac[c2] for c1 in m.Component]) for c2 in
             m.Component])
    ...
    def RecoWnSelfH0_Calc(m, comp):  # unit: J/mol
        if comp == 'Argon':
            ...
            return 4.18 * (m.PR_DHFORM[comp] + m.PR_CPIGDP1[comp] * ((m.RecoWnTemp + 273.15) - m.PR_RefTemp[comp]) + 2 *
                           m.PR_CPIGDP2[comp] * \
    ...
    def RecoGoxSelfai_Calc(m, comp):
        return 0.45724 * m.RecoGoxSelfalpha[comp] * (m.PR_RGas ** 2) * (m.PR_CrtcTemp[comp] ** 2) / m.PR_CrtcPressure[
            comp]
    ...
    def RecoGoxSelfaV_Calc(m):
        return sum([sum([m.RecoGoxSelfaij[c1, c2] * m.LPCReboilerLiqLvMFrac[c1] * m.LPCReboilerLiqLvMFrac[c2] for c1 in
                         m.Component]) for c2 in m.Component])
    ...
    def LPCMassBlnc(m, tray, comp):
        if tray == 1:
            ...
            return (m.LPCLiqLvMCompFlow[tray + 1, comp] + m.LPCVapLvMCompFlow[tray - 1, comp] - m.LPCLiqLvMCompFlow[
                tray, comp] - m.LPCVapLvMCompFlow[tray, comp] - m.LPCExt46MFlow * m.LPCExt46MFrac[comp]) * 0.001000 == 0
        elif tray == 52:
    ...
    def ASCCondSelfSqrt_ai_Calc(m, comp1, comp2):
        return m.ASCCondSelfSqrt_ai[comp1, comp2] ** 2 - m.SRK_ai[comp1] * m.ASCCondSelfalpha[comp1] * m.SRK_ai[comp2] * \
    ...
    def RecoGoxEngBlnc(m):
        return ((m.LPCReboilerLiqLvMEtlp - m.RecoGoxMEtlp) * m.OxSplitterOutBMFlow + m.RecoGoxMHeat) * 1.000000e-04 == 0
    ...
    if build_constraint:
        # Purity
        def PurityCon1(m):
            return m.LPCReboilerLiqLvMFrac['Oxygen'] >= 0.999  # 0.999

        test_model.PurityCon1 = Constraint(rule=PurityCon1)

        def PurityCon2(m):
            return m.LPCReboilerLiqLvMFrac['Nitrogen'] <= 8e-6

        test_model.PurityCon2 = Constraint(rule=PurityCon2)

        def PurityCon3(m):
            return m.LPCVapLvMFrac[52, 'Nitrogen'] >= 0.9999

        test_model.PurityCon3 = Constraint(rule=PurityCon3)

        def PurityCon4(m):
            return m.LPCVapLvMFrac[52, 'Oxygen'] <= 8e-6

        test_model.PurityCon4 = Constraint(rule=PurityCon4)

        def PurityCon5(m):
            return m.ASCCondVapMFrac['Oxygen'] <= 8e-6

        test_model.PurityCon5 = Constraint(rule=PurityCon5)

        def PurityCon6(m):
            return m.LPCVapLvMFrac[15, 'Nitrogen'] <= 8e-4  # 8e-4

        test_model.PurityCon6 = Constraint(rule=PurityCon6)

        # Product Flowrate - 根据工况要求调整
        def ProductCon1(m):
            return m.OxSplitterOutBMFlow >= LOX / 22.4

        test_model.ProductCon1 = Constraint(rule=ProductCon1)

        def ProductCon2(m):
            return m.LPCVapLvMFlow[52] >= 16000 * 2 / 22.4  # 2

        test_model.ProductCon2 = Constraint(rule=ProductCon2)

        def ProductCon3(m):
            return m.ASCCondVapMFlow >= 16000 / 32 / 22.4  # 32

        test_model.ProductCon3 = Constraint(rule=ProductCon3)

        # Temperature Difference
        def TempDiffCon1(m):
            return m.HPCTrayTemp[41] - m.LPCReboilerTemp >= 1.5

        test_model.TempDiffCon1 = Constraint(rule=TempDiffCon1)

        def TempDiffCon2(m):
            return m.ASCTrayTemp[190] - m.HeatLPCTemp >= 3

        test_model.TempDiffCon2 = Constraint(rule=TempDiffCon2)

        # Turbine
        def TurbineCon1(m):
            return m.FeedSplitterOut3MFlow >= 1.32315 * 0.8 * m.OxSplitterOutBMFlow  # 1.05852

        test_model.TurbineCon1 = Constraint(rule=TurbineCon1)

        def TurbineCon2(m):
            return m.FeedSplitterOut3MFlow <= 1.32315 * 1.2 * m.OxSplitterOutBMFlow  # 1.58778

        test_model.TurbineCon2 = Constraint(rule=TurbineCon2)

        def TurbineCon3(m):
            return m.FeedSplitterOut3MFlow + m.FeedSplitterOut1MFlow + m.FeedSplitterOut2MFlow >= 0.6 * 4461.574  # 2676.9444

        test_model.TurbineCon3 = Constraint(rule=TurbineCon3)

        def TurbineCon4(m):
            return m.FeedSplitterOut3MFlow + m.FeedSplitterOut1MFlow + m.FeedSplitterOut2MFlow <= 1.5 * 4461.574  # 6692.361

        test_model.TurbineCon4 = Constraint(rule=TurbineCon4)

        def TurbineCon7(m):
            return m.FeedSplitterOut3MFlow >= 0.6 * 1236.75  # 742.05

        test_model.TurbineCon7 = Constraint(rule=TurbineCon7)

        def TurbineCon8(m):
            return m.FeedSplitterOut3MFlow <= 1.5 * 1236.75  # 1855.125

        test_model.TurbineCon8 = Constraint(rule=TurbineCon8)

        def TurbineCon9(m):
            return m.FeedSplitterOut1MFlow >= 0.6 * 1236.3  # 741.78  #0.6

        test_model.TurbineCon9 = Constraint(rule=TurbineCon9)

        def TurbineCon10(m):
            return m.FeedSplitterOut1MFlow <= 1.5 * 1236.3  # 1854.45

        test_model.TurbineCon10 = Constraint(rule=TurbineCon10)

        # Overall Heat Balance
        def OverallHeatBlnc(m):
            return m.RecoGanMHeat + m.RecoWnMHeat + m.RecoGarMHeat + m.RecoGoxMHeat - m.TaCoolerMHeat - m.MaCoolerMHeat - m.HpaCoolerMHeat <= 0

        test_model.OverallHeatBlnc = Constraint(rule=OverallHeatBlnc)
    ...
    test_model.OBJ = Objective(rule=ObjExpr)
    return test_model
